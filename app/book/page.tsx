    ...
    <section className=" pb-[50px] bg-[#162237]">
      <div className="featured-Image flex items-center justify-center min-h-[100vh] ">
        <div className="flex flex-col lg:flex-row items-center h-[60%] w-[85%]  lg:gap-[100px]">
          <div className="w-full mt-5 lg:mt-0 lg:w-[60%] rounded-lg min-h-[300px] overflow-hidden">
            <FeatureImages />
          </div>
      ...
      <div className="description w-[85%] mt-5 lg:mt-0 lg:w-[60%] bg-white mx-auto p-6 rounded-lg">
